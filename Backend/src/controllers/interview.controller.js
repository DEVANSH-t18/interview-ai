    ...
    try {
        ...
        if (req.file) {
            try {
                ...
                return res.status(400).json({
                    message: "Failed to parse the uploaded resume. Please ensure it is a valid PDF file."
                });
            }
        }
        ...
        return res.status(500).json({
            message: "An error occurred while generating the interview report. Please try again.",
            error: err.message
        });
    }
}
